...
def process_data(
    ...
    Note: depending on the model used, you may want to scale the continuous
    data.
    ...
    label : str
        Name of the label column in `X`. If None, an empty array is returned
        for y.
    training : bool
...
def apply_label(inference):
    """Convert the binary label in a single inference sample into text."""
    if inference[0] == 1:
        return ">50K"
    return "<=50K"
